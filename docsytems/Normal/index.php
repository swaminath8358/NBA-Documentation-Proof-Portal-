...
<html>
    <head>
        <title>NBA Portal | Home Page</title>
    ...
    <nav style = "text-align: center;">
        ...
        <div id="wrap">
            <div id="header">
                <div id="logo">
                    <h1 style="text-align: center;color: green;"><span><img src="../image/Address Book.png" alt="logo"/></span>NBA Documentation Proof Portal</h1>  
                </div>
                </div>
            <div id="menu">
                <ul>
